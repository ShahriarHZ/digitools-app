  ...
  return (
    <div className="navbar bg-base-100 py-4 px-0">
      ...
      <div className="navbar-end gap-2 md:gap-4">
        ...
        <button className="btn btn-ghost hidden md:flex">Login</button>
        
        <button className="btn bg-linear-to-r from-purple-600 to-blue-500 text-white border-none rounded-xl px-6">
          Get Started
        </button>
      </div>
    </div>
